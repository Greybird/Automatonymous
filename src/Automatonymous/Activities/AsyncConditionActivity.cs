...
namespace Automatonymous.Activities
{
    ...
    public class AsyncConditionActivity<TInstance> :
        Activity<TInstance>
        where TInstance : class
    {
        ...
        public AsyncConditionActivity(StateMachineConditionAsync<TInstance> condition, Behavior<TInstance> behavior)
        {
    ...
    public class AsyncConditionActivity<TInstance, TData> :
        Activity<TInstance>
        where TInstance : class
    {
        readonly Behavior<TInstance> _behavior;
        ...
        public AsyncConditionActivity(StateMachineConditionAsync<TInstance, TData> condition, Behavior<TInstance> behavior)
        {
            _condition = condition;
            _behavior = behavior;
        }
